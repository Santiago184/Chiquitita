...
const passwordField=document.querySelector("[name=clave]");
const passwordvField=document.querySelector("[name=clavev]");
...
passwordvField.addEventListener("blur",function (e){
    const field=e.target;
    const fieldValue=e.target.value;
    if(fieldValue.trim().length == 0){
        field.classList.add("invalid")
